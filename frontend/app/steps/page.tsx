  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold">Assembly Steps</h1>
          <p className="text-gray-400 text-sm mt-1">
            Select a manual to view its step-by-step instructions.
          </p>
        </div>
        <Link
          href="/ingest"
      ...
      {!loading && !error && manuals.length === 0 && (
        <div className="flex flex-col items-center justify-center py-24 gap-4 text-center border border-dashed border-gray-700 rounded-2xl">
          ...
          <p className="text-gray-500 text-sm max-w-xs">
            Ingest a LEGO instruction manual to see its assembly steps here.
          </p>
          <Link
            href="/ingest"
